            ...
            ?>
                    <div class="col mb-5">
                        <div class="card shadow">
                            <img <?php echo "<img src='../kosia/kosia-admin/admin/img/$data[Articles_ImageURL]'; " ?> class="card-img-top" />
                            <div class="d-none deskripsi">
                                <?php echo $data["Articles_Description"] ?>
                            </div>
